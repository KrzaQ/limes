...
#
# -----------------------------------------------------------------------------
# Vendored into limes, verbatim, from Moby (https://github.com/moby/moby).
#   source:  https://raw.githubusercontent.com/moby/moby/v28.3.3/contrib/dockerd-rootless.sh
#   tag:     v28.3.3
#   license: Apache-2.0 (https://github.com/moby/moby/blob/v28.3.3/LICENSE)
#
# limes runs its own copy of this launcher so rootless-Docker setup needs only
# official-repo packages (docker + rootlesskit + slirp4netns + shadow) -- no AUR
# 'docker-rootless-extras' on Arch, no 'docker-ce-rootless-extras' on Debian/Ubuntu.
